...
import BANNER_1 from "../../public/banner/01.jpg";
import BANNER_2 from "../../public/banner/02.jpg";
import BANNER_3 from "../../public/banner/03.jpg";
import BANNER_4 from "../../public/banner/04.jpg";
...
const redirectToInsta = () => {
  ...
  //   "https://instagram.com/lims_coe?igshid=MzMyNGUyNmU2YQ==";
};
    ...
    <>
      <Box className={classes.root}>
        ...
        <Box className={classes.titleContainer}>
          ...
          Ensure Food security and optimize agriculture production in Pakistan through innovative technologies and sustainable precision driven agricultural practices based on agro-ecological potential of land, while ensuring well-being of rural communities and preservation of environment.
          </p>
